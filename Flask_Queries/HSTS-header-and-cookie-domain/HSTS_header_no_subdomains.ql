...
class HSTSConfiguration extends DataFlow::Configuration {
    ...
    override predicate isSource(DataFlow::Node source) {
        ...
        */
        ...
        and not exists(source.asExpr().(Str).getText().indexOf("includeSubDomains"))
    }
...
where exists(DataFlow::Node source, DataFlow::Node sink, HSTSConfiguration config, DataFlow2::Node func, DataFlow2::Node node, HSTSConfiguration2 fconfig |
