...
from Expr expr
where (expr = getConfigValueFromObject("SESSION_COOKIE_DOMAIN")
    or expr = getConfigValueFromPyFile("SESSION_COOKIE_DOMAIN")
    or expr = getConfigValue("SESSION_COOKIE_DOMAIN")
    or expr = getConfigValueFromDictionary("SESSION_COOKIE_DOMAIN"))
  and valueCheck(expr)
