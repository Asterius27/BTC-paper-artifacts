...
where exists(DataFlow::Node login | 
        login = API::moduleImport("django").getMember("contrib").getMember("auth").getMember("logout").getAValueReachableFromSource()
    ...
    or exists(DataFlow::Node views | 
        views = API::moduleImport("django").getMember("contrib").getMember("auth").getMember("views").getMember("LogoutView").getAValueReachableFromSource()
