...
// findInterestingRepos("Password-hashing", "un_md5_is_used.txt", true, 0, Number.MAX_VALUE, './repos_with_interesting_results/22bis - repos_using_md5_to_hash_passwords_django_manually_filtered_list_v1.txt');
...
findOverlappingResultsInRepos({"Password-strength": ["un_flask_wtf_is_used.txt"], "Password-hashing": ["un_flask_bcrypt_is_used.txt", "un_argon2_is_used.txt", "un_bcrypt_is_used.txt", "un_hashlib_is_used.txt", "un_passlib_is_used.txt", "un_werkzeug_is_used.txt"]}, [true, false, false, false, false, false, false], './repos_with_interesting_results/14 - v2_repos_with_no_hashing_library_flask_login_flask_wtf_filtered_merged_list_final_v2.txt');
