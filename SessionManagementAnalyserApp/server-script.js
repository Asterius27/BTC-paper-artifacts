...
findInterestingRepos("Password-strength", "un_password_custom_checks.txt", true, 0, Number.MAX_VALUE, './repos_with_interesting_results/10 - repos_with_custom_password_strength_checks_flask_login_final_filtered_merged_list.txt');
findInterestingRepos("Explorative-queries", "un_custom_session_interface.txt", true, 0, Number.MAX_VALUE, './repos_with_interesting_results/10 - repos_with_custom_session_interface_flask_login_final_filtered_merged_list.txt');
findOverlappingResultsInRepos({"Password-hashing": ["un_form_with_password_field.txt", "un_form_with_password_field_and_validators.txt"]}, [true, false], './repos_with_interesting_results/10 - repos_that_have_all_password_fields_without_validators_flask_login_final_filtered_merged_list.txt'); // looks for repos where the specified set of queries return the results specified by the list (that is the second parameter). The order of the queries corresponds to the order of the results in the list.
