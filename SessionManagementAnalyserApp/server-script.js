...
findOverlappingResultsInRepos({"Password-hashing": ["un_form_with_password_field.txt", "un_form_with_password_field_and_validators.txt"]}, [true, false], './repos_with_interesting_results/9bis - repos_that_have_all_password_fields_without_validators_flask_login_final_filtered_merged_list.txt'); // looks for repos where the specified set of queries return the results specified by the list (that is the second parameter). The order of the queries corresponds to the order of the results in the list.
