...
// findInterestingRepos("Password-hashing", "un_passlib_bcrypt_is_owasp_compliant.txt", true, 0, Number.MAX_VALUE, './repos_with_interesting_results/27 - repos_with_passlib_bcrypt_owasp_compliant_flask_login_whitelist_filtered_list.txt');
...
deleteQueriesResults({"CSRF": ["un_using_wtforms_csrf_protection"], "Password-strength": ["un_form_with_password_field_is_signup", "un_password_custom_checks", "un_password_length_check", "un_password_regexp_check"]});
// libraryUsagesGrep();
