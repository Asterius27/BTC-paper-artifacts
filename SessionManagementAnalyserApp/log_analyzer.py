...
path = Path(__file__).parent / './old_logs/12 - log_flask_login_final_filtered_merged'
output = Path(__file__).parent / './old_logs/12 - log_flask_login_final_filtered_merged/log_analysis_merged.txt'
