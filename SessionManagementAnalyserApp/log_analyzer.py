...
path = Path(__file__).parent / './old_logs/34 - log_crystallized_dataset_django_v2'
output = Path(__file__).parent / './old_logs/34 - log_crystallized_dataset_django_v2/log_analysis_merged.txt'
