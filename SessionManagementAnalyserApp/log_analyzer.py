...
path = Path(__file__).parent / './old_logs/23 - log_repos_whitelist_filtered_list_v1'
output = Path(__file__).parent / './old_logs/23 - log_repos_whitelist_filtered_list_v1/log_analysis_merged.txt'
