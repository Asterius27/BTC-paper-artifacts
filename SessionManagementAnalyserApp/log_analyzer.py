...
path = Path(__file__).parent / './old_logs/17 - log_django_filtered_list_final_v2'
output = Path(__file__).parent / './old_logs/17 - log_django_filtered_list_final_v2/log_analysis_merged.txt'
