...
path = Path(__file__).parent / './old_logs/22bis - log_repos_from_django_manually_filtered_list_v1'
output = Path(__file__).parent / './old_logs/22bis - log_repos_from_django_manually_filtered_list_v1/log_analysis_merged.txt'
