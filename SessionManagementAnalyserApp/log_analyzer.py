...
path = Path(__file__).parent / './old_logs/35 - log_crystallized_dataset_flask_v5'
output = Path(__file__).parent / './old_logs/35 - log_crystallized_dataset_flask_v5/log_analysis_merged.txt'
