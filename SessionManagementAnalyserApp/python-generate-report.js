...
export function generateReport(results, lib, dir) {
    ...
    if (lib === "Flask/Flask-login") {
        ...
        */
        ...
        html += "<td>" + aux("SessionFixation", "Cookie-name-prefixes", "st_session_cookie_name_prefix", results, "") + "</td>";
        html += "<td>" + aux("SessionFixation", "Cookie-name-prefixes", "st_remember_cookie_name_prefix", results, "") + "</td></tr>";
        /*
