...
path1 = Path(__file__).parent / '../from_flask_login_final.csv'
path2 = Path(__file__).parent / '../import_flask_login_final.csv'
output = Path(__file__).parent / '../flask_login_final_merged_list.csv'
