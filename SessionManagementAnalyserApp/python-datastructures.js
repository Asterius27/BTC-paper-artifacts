    ...
    "CSRF": {
        ...
        */
        "CSRF": {
            ...
            "un_changing_csrf_protected_methods": [false, ""],
            "un_disabled_wtf_csrf": [false, ""],
            "un_setting_wtf_csrf_secret_key": [false, ""],
            "un_using_flaskform_with_csrf_disabled": [false, ""]
        }
    },
    /*
...
let config = {
    ...
    "CSRF": {
        "options": 'var options = {"title":"CSRF","width":1500,"height":2500,"legend": {"position": "top", "maxLines": 3},"bar": {"groupWidth": "75%"},"isStacked": true};\n',
        "element_id": 'csrf'
    },
    "ClientSideSessionIvalidation": {
