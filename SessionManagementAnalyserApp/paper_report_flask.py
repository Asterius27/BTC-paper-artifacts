...
repos_using_csrf_library = keys_using_flask_wtf.union(keys_using_wtforms).union(keys_csrf_enabled_globally).difference(keys_csrf_enabled_globally.intersection(keys_disabled_flask_wtf_csrf_global_protection))
repos_with_csrf_disabled = keys_using_flask_wtf.union(keys_using_wtforms).union(keys_csrf_enabled_globally).intersection(keys_csrf_enabled_globally.intersection(keys_disabled_flask_wtf_csrf_global_protection))
