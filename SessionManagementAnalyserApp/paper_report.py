...
keys_custom_password_validators = set(custom_password_validators)
keys_length_password_validators = set(length_password_validators)
keys_regexp_password_validators = set(regexp_password_validators)
length_and_regexp_password_validators = keys_length_password_validators.intersection(keys_regexp_password_validators)
performing_password_validation = keys_custom_password_validators.union(keys_length_password_validators).union(keys_regexp_password_validators)
...
csrf_protection_global = keys_csrf_enabled_globally.difference(keys_using_csrf_exempt).difference(keys_disabled_flask_wtf_csrf_protection)
csrf_protection_global_selectively_disabled = keys_using_csrf_exempt.union(keys_disabled_flask_wtf_csrf_protection)
