...
path_o = Path(__file__).parent / '../flask_login_final_filtered_merged_list_w_lang_and_readme.csv'
log_path = Path(__file__).parent / './filter_logs/flask_login_final_filtered_merged_list_w_lang_and_readme.txt'
filtered_repos = 0
number_of_repos = 0
