...
path_o = Path(__file__).parent / '../django_final_filtered_list_w_lang_and_readme.csv'
log_path = Path(__file__).parent / './filter_logs/django_final_filtered_list_w_lang_and_readme.txt'
filtered_repos = 0
number_of_repos = 0
